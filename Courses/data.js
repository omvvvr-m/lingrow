const courses = [
  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PLfSUFKdFlttn1MWrG5Q0-a9Cbm9y3uulX" target="_blank">Watch Full Playlist on YouTube</a>`
  },

  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PLTyvAtj9OYb00pBe-pnqIB18qXchcvLii" target="_blank">Watch Full Playlist on YouTube</a>`
  },

  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PL-hlJtdAqBx0v9O7s9vYJnLbCOT9GN-wW" target="_blank">Watch Full Playlist on YouTube</a>`
  },

  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PL2IkMHFHWdEo-t2mIKmk_HwrJYOTwlT0i" target="_blank">Watch Full Playlist on YouTube</a>`
  },

  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PL5bLw9Uguvv3kSpd1tM79vb0DGAG67dab" target="_blank">Watch Full Playlist on YouTube</a>`
  },

  {
    ...
    📺 <a href="https://www.youtube.com/playlist?list=PLB8Nx5XHhSwS0--eC0exptjztydVsjjUI" target="_blank">Watch Full Playlist on YouTube</a>`
  }
];
